...
<!-- Blog Timeline-->
	<div class="blog-container">
		<?php if($this->item->params->get('catItemImage') && !empty($this->item->image)): ?>
                    <img src="<?php echo $this->item->image; ?>" alt="<?php echo K2HelperUtilities::cleanHtml($this->item->title); ?>" class="img-responsive pull-left blog-image"/>
                    </a>
        <?php endif; ?>
	...
	<?php endif; ?>
		<?php if ($this->item->params->get('catItemReadMore')): ?>
			<li class="blog-next text-center"><a href="<?php echo $this->item->link; ?>"><i class="fa fa-long-arrow-right"></i></a></li>
		<?php endif;?>
		</ul>							
...
<?php echo "this is from the timeline template"; ?>
