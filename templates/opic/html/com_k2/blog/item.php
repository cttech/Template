...
<div id="contact" class="form-section animated" data-animation="fadeInUp" data-animation-delay="300">
	...
	<form name="contactform" id="contactForm" method="post" action="send.php">
		<input type="text" name="senderName" id="senderName" placeholder="Your Name" class="input-text" required>
		<input type="email" name="senderEmail" id="senderEmail" placeholder="Your E-mail" class="input-text" required>
		<textarea name="message" id="message" class="text-area" placeholder="Comments" required></textarea>
		<input type="submit" name="sendMessage" id="sendMessage" value="Send Message" class="btn-msg white">
	</form><!-- Form Ends -->	
</div>
